<template>
    <div class="mine">
        <scroll ref="scroll">
            <mine-top :headImg="headImg" :fans="fans" :follows="follows" :level="level" :bgImg="bgImg"></mine-top>
            <message :createDays="createDays" :gender="gender" :birthday="birthday"></message>
            <create></create>
