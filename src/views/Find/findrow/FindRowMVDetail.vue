        ...
        <scroll :data="comments">
            ...
            <div class="title">
                ...
                <div class="detail">
                    ...
                    <span class="playcount">播放：{{detail.playCount | countFilter}}</span>
            ...
            <div class="comment">
                ...
                <div class="comment-block" v-if="detail.commentCount!=0">
                    <div class="comment-item" v-for="(item,index) in comments" :key="index">
                        <div class="img">
                            ...
                            <div class="like" @click="toLike(index)">
                                <img v-show="!item.liked" src="~assets/img/findd/findrow/like.png">
                                <img v-show="item.liked" src="~assets/img/findd/findrow/like-active.png">
                    ...
                    <div class="bottom">
                        <div class="content" v-if="!isLoading&&!finish" @click="getComments($route.query.id)">
                            点击加载更多...
                        </div>
                        <div class="content" v-if="finish">已经到底部啦...</div>
                        <van-loading v-show="isLoading" style="text-align: center" size="14px">加载中...</van-loading>
                    </div>
                </div>
