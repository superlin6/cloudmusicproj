  ...
  <div class="operation">
    ...
    <div class="operation-bottom">
      ...
      <div class="stop-and-play" @click="changeStatus">
        ...
        <img
          v-show="!status"
          src="@/static/img/components/audiobar/stop_song.png"
        />
        <img
          v-show="status"
          src="@/static/img/components/audiobar/play_song.png"
        />
      </div>
...
import { toLike } from "../../../../network/Components/AudioBar/audiobar";
...
export default {
  ...
  methods: {
    ...
    changeCurTime(val) {
      // console.log('修改了'+val)
      if (this.curTime != 0 && this.sumTime != 0)
        //防止无歌曲时拖动
  ...
  filters: {
    playTime(val) {
      ...
      let s =
        parseInt(val % 60) < 10 ? "0" + parseInt(val % 60) : parseInt(val % 60); //秒
      if (m == 0 && s == 0) {
        return "0:00";
      } else {
        return m + ":" + s;
...
<style src="assets/css/components/audiobar/songview/operation.css"></style>
