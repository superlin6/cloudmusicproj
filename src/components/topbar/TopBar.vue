<template>
    <div class="topbar">
        <top-bar-block
                :style="{backgroundColor:($route.path=='/home'||$route.path=='/find'?'#f6f6f6':($route.path=='/mine'?'rgba(255,255,255,.9)':'#fff'))}">
            <top-bar-item>
                <!-- 个人菜单 -->
                <div slot="item-option">
                    <img src="~assets/img/components/topbar/option_left.png" @click="option">
                </div>
                <!-- 返回 -->
                <div slot="item-back">
            ...
            <top-bar-item v-if="$route.path!='/home'||$route.path!='/songview'" class="center">
                <!-- 歌单 -->
                ...
                <!-- 发现+搜索 -->
                <div slot="item-find">
                    <van-field v-model="value" placeholder="搜索歌曲、MV" @click.prevent="toSearch" @keyup.13="search"/>
                </div>
                <!-- 我的 -->
            ...
            <top-bar-item>
                <div slot="item-search">
                    <img src="~assets/img/components/topbar/search.png" @click="toSearch">
                </div>
                <div slot="item-mine">
...
<script>
    ...
    export default {
        ...
        // watch: {
        //     $route(to, from) {
        //         if (to.path == '/find' || to.path == '/home' ||
        //             to.path == '/mine' || to.path == '/setting') {
        //             this.type = 0;
        //         } else {
        //             this.type = 1;
        //         }
        ...
        // },
        // mounted() {
        //     if (this.$route.path == '/find' || this.$route.path == '/home' ||
        //         this.$route.path == '/mine' || this.$route.path == '/setting') {
        //         this.type = 0;
        //     }
        // }
    }
