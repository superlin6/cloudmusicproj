<template>
    <div id="app">
        <div class="main">
            ...
            <keep-alive include="Home,Find,Mine,Rank,RankList,CreateList,CollectList,FindRowItemList"><router-view/></keep-alive>
            <top-bar v-if="$route.path!='/login'"></top-bar>
            <audio-bar v-if="$route.path=='/login'?false:true" v-show="$route.path!='/songview'"></audio-bar>
            <tab-bar v-if="$route.path=='/home'||this.$route.path=='/find'
